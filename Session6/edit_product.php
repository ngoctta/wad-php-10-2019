                      ...
                      <form class="user" action="#" method="POST">
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control form-control-user" 
                                ...
                                value="<?php echo isset($_POST['description']) ? $_POST['description'] : $oldDescription ?>">
                        ...
                        <div class="form-group">
                          <input type="number" class="form-control form-control-user" 
                                name="price" 
                                placeholder="Price" 
                                value="<?php echo isset($_POST['price']) ? $_POST['price'] : $oldPrice ?>">
                        ...
                        <div class="form-group">
                          <input type="number" class="form-control form-control-user" 
                                ...
                                value="<?php echo isset($_POST['discount']) ? $_POST['discount'] : $oldDiscount ?>">
